import { Application, Color, Container, FixedResolutionCanvasSizing, Graphics, LinearGradient, RadialGradient, type RenderingContext, Scene, type Time } from '@codexo/exojs';
