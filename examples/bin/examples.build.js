...
var _exojs = __webpack_require__(7);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _jquery2.default)(function () {
    var loader = new _exojs.Loader({ cache: 'no-cache' }),
        $navigation = (0, _jquery2.default)('.navigation-list'),
        $preview = (0, _jquery2.default)('.example-preview'),
        $title = (0, _jquery2.default)('.editor-title'),
        $code = (0, _jquery2.default)('.editor-code'),
        $refresh = (0, _jquery2.default)('.refresh-button'),
        activeExample = null,
        activeEditor = null,
        activePath = location.hash.slice(1),
        createExample = function createExample(html) {
        var $frame = (0, _jquery2.default)('<iframe>', {
            'class': 'preview-frame',
            'src': 'preview.html'
        });
        ...
        $frame.contents().find('body').append((0, _jquery2.default)('<script>window.onload = function(){' + html + '}</script>'));

        $code.html(html);

        if (activeEditor) {
            (0, _jquery2.default)(activeEditor.getWrapperElement()).remove();
        }

        activeEditor = _codemirror2.default.fromTextArea($code[0], {
            mode: 'javascript',
        ...
        try {
            for (var _iterator = entries[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                $navigation.append((0, _jquery2.default)('<div>', {
...
(function (mod) {
  if (( false ? "undefined" : _typeof(exports)) == "object" && ( false ? "undefined" : _typeof(module)) == "object") // CommonJS
    mod(__webpack_require__(0));else if (true) // AMD
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (mod),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
