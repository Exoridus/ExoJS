import { Application, BlendModes, Color, FixedResolutionCanvasSizing, Graphics, type RenderingContext, Scene } from '@codexo/exojs';
import {
  ApplyForce,
  ColorGradient,
  ColorOverLifetime,
...
class BonfireScene extends Scene {
  ...
  private fireRate = new Constant(50);
  private wind = new ApplyForce(0, 0);
  private smokeWind = new ApplyForce(0, 0);
