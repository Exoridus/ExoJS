 ...
 */
const buildWorld = (tiles: readonly WorldTile[], layer: Container) =>
...
class CoroutineLoadingScene extends Scene {
  ...
  private label!: Text;
  private build: Coroutine<number, number> | null = null;
  ...
  private start(): void {
    ...
    const tiles: WorldTile[] = Array.from({ length: TILE_COUNT }, (_unused, index) => ({
