...
/** One effect in a chain, with the parameter that gives it its character. */
interface Stage {
    name: string;
    detail: string;
    create(context: ChainContext): AudioEffect;
}
...
const CHAINS: Array<Chain> = [
    ...
    },
    {
        ...
        stages: [
            { name: 'Flanger', detail: '0.15 Hz, fb 0.85', create: () => new FlangerEffect({ delayMs: 3, depthMs: 4, rateHz: 0.15, feedback: 0.85, wet: 0.6 }) },
    ...
    },
    {
        ...
        stages: [
            { name: 'Phaser', detail: '8 stages, 0.3 Hz', create: () => new PhaserEffect({ stages: 8, rateHz: 0.3, baseFrequency: 400, depth: 0.8, feedback: 0.6, wet: 0.6 }) },
    ...
    },
    {
        ...
        stages: [
            ...
            { name: 'AutoWah', detail: '180 Hz, Q 6', create: () => new AutoWahEffect({ baseFrequency: 180, sensitivity: 3500, q: 6, responseMs: 20, wet: 0.8 }) },
        ],
    },
    {
        name: 'Alien Voice',
    ...
    },
    {
        ...
        stages: [
            { name: 'Granular', detail: '80 ms, 30/s', create: () => new GranularEffect({ grainSize: 0.08, density: 30, spread: 0.7, pitchMin: 0.98, pitchMax: 1.02, wet: 0.9, normalizeGain: true }) },
    ...
    },
    {
        ...
        stages: [
            { name: 'Compressor', detail: '-28 dB, 12:1', create: () => new CompressorEffect({ threshold: -28, ratio: 12, attack: 0.003, release: 0.15, knee: 6 }) },
