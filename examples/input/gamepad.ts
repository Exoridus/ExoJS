import { Application, Color, Container, GamepadAxis, GamepadButton, Json, lerp, Scene, Sprite, Spritesheet, type SpritesheetData, Texture, Vector } from '@codexo/exojs';
...
class GamepadScene extends Scene {
    ...
    override async init(): Promise<void> {
        const buttonsData = (await this.loader.load(Json, 'json/buttons.json')) as SpritesheetData;

        this.buttons = new Spritesheet(this.loader.get(Texture, 'image/buttons.png'), buttonsData);
