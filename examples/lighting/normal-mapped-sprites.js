...
import { Application, Color, Container, FixedResolutionCanvasSizing, ScaleModes, Scene, ShaderSource, Sprite, SpriteMaterial, Texture } from '@codexo/exojs';
...
const lightUniforms = { u_ambient: [0.12, 0.12, 0.16, 0] };
