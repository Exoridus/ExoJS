import { Application, CallbackRenderPass, Color, FixedResolutionCanvasSizing, type RenderingContext, RenderNodePass, RenderPipeline, RenderTexture, Scene, Sprite, type Time } from '@codexo/exojs';
