import { Application, Color, Container, FixedResolutionCanvasSizing, Graphics, type RenderingContext, RenderNodePass, RenderPipeline, RenderTexture, Scene, Sprite, type Time, View } from '@codexo/exojs';
