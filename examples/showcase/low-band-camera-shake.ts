import { Application, Asset, AudioStream, Color, FixedResolutionCanvasSizing, type RenderingContext, Scene, Sprite, Text, type Time, View, type Voice } from '@codexo/exojs';
