...
const PRESETS = [
    { label: 'Tint', apply: (filter: ColorMatrixFilter): ColorMatrixFilter => filter.tint(new Color(255, 160, 120)) },
    { label: 'Desaturate', apply: (filter: ColorMatrixFilter): ColorMatrixFilter => filter.grayscale() },
    { label: 'Invert', apply: (filter: ColorMatrixFilter): ColorMatrixFilter => filter.invert() },
    { label: 'Brightness', apply: (filter: ColorMatrixFilter): ColorMatrixFilter => filter.brightness(1.6) },
    { label: 'Contrast', apply: (filter: ColorMatrixFilter): ColorMatrixFilter => filter.contrast(1.8) },
    { label: 'Sepia', apply: (filter: ColorMatrixFilter): ColorMatrixFilter => filter.sepia() },
] as const;
