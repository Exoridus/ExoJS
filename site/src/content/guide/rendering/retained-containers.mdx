...
<SourceSnippet
  source="examples/guides/retained-containers/decor-layer.ts"
  region="retained-layer"
  language="ts"
  title="examples/guides/retained-containers/decor-layer.ts"
/>
