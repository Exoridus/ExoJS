...
- The [Streamed Terrain](/ExoJS/en/examples/tilemap/worker-streamed-terrain/) example explores an endless value-noise world, rerolls the seed, and compares sync and worker providers under a tunable sample cost.
