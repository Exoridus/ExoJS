...
**Stars** with configurable points, inner radius, and rotation (default inner radius is half the outer radius):
```js
g.drawStar(centerX, centerY, points, radius, innerRadius, rotationDegrees);
```
...
The next chapter, [Sprites](/ExoJS/en/guide/drawing/sprites/), covers the primary textured drawable — loading images, positioning, sizing, and the relationship between textures and sprites.
