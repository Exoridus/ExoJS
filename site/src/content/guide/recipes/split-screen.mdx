...
Two players on one keyboard or optional controllers: WASD controls the blue ship (left view), arrow keys control the orange ship (right view). Each view follows its player.
