...
<SourceSnippet
  source="examples/guides/pause-menu/pause-scene.ts"
  region="pause-scene"
  language="ts"
  title="examples/guides/pause-menu/pause-scene.ts"
/>
...
<SourceSnippet
  source="examples/guides/pause-menu/menu-buttons.ts"
  region="menu-buttons"
  language="ts"
  title="examples/guides/pause-menu/menu-buttons.ts"
/>
...
Continue with [Split screen](/ExoJS/en/guide/runtime/coordinates-and-views/), which covers rendering the same scene from multiple viewpoints into viewport regions.
