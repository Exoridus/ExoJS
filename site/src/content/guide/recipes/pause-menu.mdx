...
The next recipe, [Split screen](/ExoJS/en/guide/runtime/coordinates-and-views/), covers rendering the same scene from multiple viewpoints into viewport regions.
