...
Continue with [Pause menu](/ExoJS/en/guide/recipes/pause-menu/), which covers how to freeze gameplay and overlay a menu using `app.scenes.pause()`/`resume()` and the `scene.ui` layer.
