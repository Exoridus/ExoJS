...
The [`RenderTargetPass`](/ExoJS/en/api/render-target-pass/) redirects drawing into the texture. The mask clips the mini-map to a circle. See [Render targets](/ExoJS/en/guide/rendering/render-targets/) and [Masks](/ExoJS/en/guide/runtime/scene-graph/#masks) for details.
