...
Switch between a menu and a game with `app.scenes.change`, then read each scene's lifecycle events on screen.
...
<TryIt
  examples={['application-scenes/multiple-scenes', 'ui/hud-and-widgets', 'getting-started/hello-world']}
  api={['scene', 'loader']}
/>
