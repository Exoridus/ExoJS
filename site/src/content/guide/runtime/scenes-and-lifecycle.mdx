...
description: 'How scenes split runtime work, compose into a stack, and the order their lifecycle hooks run in.'
---
...
<TryIt
  examples={['application-scenes/multiple-scenes', 'application-scenes/scene-lifecycle', 'getting-started/game-loop']}
  api={['scene', 'loader']}
/>
