...
Continue with [Coordinates and views](/ExoJS/en/guide/runtime/coordinates-and-views/), which covers world-vs-screen coordinates, the camera (`View`), and how to handle different canvas sizes without breaking layout assumptions.
