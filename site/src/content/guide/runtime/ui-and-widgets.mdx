...
On top of that layer, ExoJS ships a small set of widgets — [`Panel`](/ExoJS/en/api/panel/), [`Button`](/ExoJS/en/api/button/), [`Label`](/ExoJS/en/api/label/), [`ProgressBar`](/ExoJS/en/api/progress-bar/), a [`Stack`](/ExoJS/en/api/stack/) layout container, a [`ScrollContainer`](/ExoJS/en/api/scroll-container/) with [`Scrollbar`](/ExoJS/en/api/scrollbar/)s for overflowing content, the form controls [`Checkbox`](/ExoJS/en/api/checkbox/), [`Toggle`](/ExoJS/en/api/toggle/), [`Slider`](/ExoJS/en/api/slider/), [`Dropdown`](/ExoJS/en/api/dropdown/) and [`TextInput`](/ExoJS/en/api/text-input/), and a hover [`Tooltip`](/ExoJS/en/api/tooltip/) helper — for HUDs, menus, and pause screens without hand-built hit-tests.
