...
<ExamplePreview slug="ui/settings-menu" />

<ExamplePreview slug="ui/text-entry-and-scrolling" />

<TryIt
    examples={['ui/hud-and-widgets', 'ui/settings-menu', 'ui/text-entry-and-scrolling']}
    api={['uiroot', 'button', 'panel', 'label', 'progress-bar', 'slider', 'toggle', 'dropdown', 'scroll-container', 'tooltip']}
/>
