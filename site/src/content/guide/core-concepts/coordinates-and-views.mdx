...
The next chapter, [Loading and resources](/ExoJS/en/guide/core-concepts/loading-and-resources/), covers the asset pipeline — how the loader gets textures, audio, and JSON into your scene before `init` runs.
