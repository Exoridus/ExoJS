...
A sound source can be dragged or set to orbit a fixed listener. Select linear, inverse, or exponential falloff to hear the difference while the readout tracks pan and attenuation.

<a id="falloff-curves"></a>
The same example lets you switch distance models without restarting its voice.
