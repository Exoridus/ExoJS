...
The `Application` constructor options also changed shape in 0.9.0. See the [v0.8.x to v0.9.0 migration guide](/ExoJS/en/guide/shipping/v0-8-x-to-v0-9-0/) for a complete list of renamed options and removed aliases.
