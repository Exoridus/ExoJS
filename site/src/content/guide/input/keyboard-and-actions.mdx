...
```ts
import { GamepadAxis, GamepadButton, Keyboard, type RenderingContext, Scene, Sprite, type Seconds } from '@codexo/exojs';
...
class GameplayScene extends Scene {
    ...
    menu = new InputScope(new ActionMap({
