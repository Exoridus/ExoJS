...
Continue with [Gamepad](/ExoJS/en/guide/input/gamepad/), which covers the four-slot gamepad system — button and axis listeners, vibration, slot strategies, and per-pad connection lifecycle.
