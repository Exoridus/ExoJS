...
The next section, [Audio basics](/ExoJS/en/guide/audio/audio-basics/), covers the audio pipeline — sound and music playback, volume and looping, buses, and the browser autoplay gesture. For unifying keyboard and gamepad behind intent-driven action names, see [action mapping](/ExoJS/en/guide/input/keyboard-and-actions/) back in the keyboard chapter.
