...
<SourceSnippet
  source="examples/guides/gamepad/capability-probe.ts"
  region="capability-probe"
  language="ts"
  title="examples/guides/gamepad/capability-probe.ts"
/>
...
<SourceSnippet
  source="examples/guides/gamepad/versus.ts"
  region="two-players"
  language="ts"
  title="examples/guides/gamepad/versus.ts"
/>
