...
<SourceSnippet
  source="examples/guides/particles/death-module.ts"
  region="splash-on-death"
  language="ts"
  title="examples/guides/particles/death-module.ts"
/>
...
<SourceSnippet
  source="examples/guides/particles/particle-scene.ts"
  region="particle-scene"
  language="ts"
  title="examples/guides/particles/particle-scene.ts"
/>
...
<SourceSnippet
  source="examples/guides/particles/update-module.ts"
  region="sway-module"
  language="ts"
  title="examples/guides/particles/update-module.ts"
/>
