...
<Callout type="pitfall" title="A green flip is not a vertical flip">
...
Neither adds a pass. Under `lightmap` the filter costs between 5 and 21 texture fetches per shadowed fragment, in step with the width asked for, and can differ between lights.
