...
<Callout type="debug" title="Read the boxes as a diagnosis">
...
<Callout type="info" title="Debug logs are dropped at runtime, not stripped from the bundle">
...
<SourceSnippet
  source="examples/guides/debugging-and-inspection/logging.ts"
  region="log-once"
  language="ts"
  title="examples/guides/debugging-and-inspection/logging.ts"
/>
...
<SourceSnippet
  source="examples/guides/debugging-and-inspection/pass-inspector.ts"
  region="pass-inspector"
  language="ts"
  title="examples/guides/debugging-and-inspection/pass-inspector.ts"
/>
...
<TryIt
  examples={['performance/backend-comparison', 'debug-layer/pointer-and-hittest']}
