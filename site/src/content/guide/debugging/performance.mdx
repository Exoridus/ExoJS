...
<Callout type="debug" title="Change one thing, then measure again">
...
<Callout type="hint" title="Pool and toggle instead of rebuilding">
...
<Callout type="pitfall" title="Per-frame new Color() / new Vector() feeds the GC">
