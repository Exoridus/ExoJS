...
<Callout type="hint" title="CallbackRenderPass first, raw device last">
...
<SourceSnippet
  source="examples/guides/custom-renderers/custom-pass-scene.ts"
  region="custom-pass-scene"
  language="ts"
  title="examples/guides/custom-renderers/custom-pass-scene.ts"
/>
...
<SourceSnippet
  source="examples/guides/custom-renderers/backend-pass.ts"
  region="backend-pass"
  language="ts"
  title="examples/guides/custom-renderers/backend-pass.ts"
/>
