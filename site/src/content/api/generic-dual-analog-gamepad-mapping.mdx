...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/input/GenericDualAnalogGamepadMapping.ts#L18"
---
...
Source: [src/input/GenericDualAnalogGamepadMapping.ts](https://github.com/Exoridus/ExoJS/blob/main/src/input/GenericDualAnalogGamepadMapping.ts#L18)
