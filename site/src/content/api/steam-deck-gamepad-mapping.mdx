...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/input/SteamDeckGamepadMapping.ts#L18"
---
...
Source: [src/input/SteamDeckGamepadMapping.ts](https://github.com/Exoridus/ExoJS/blob/main/src/input/SteamDeckGamepadMapping.ts#L18)
