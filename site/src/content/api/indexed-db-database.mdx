...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/resources/IndexedDbDatabase.ts#L37"
---
## Import
...
[src/resources/IndexedDbDatabase.ts](https://github.com/Exoridus/ExoJS/blob/main/src/resources/IndexedDbDatabase.ts#L37)
