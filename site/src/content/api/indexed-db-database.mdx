...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/resources/IndexedDbDatabase.ts#L21"
---
# IndexedDbDatabase
...
- `name: string`
- `version: number`
Source: [src/resources/IndexedDbDatabase.ts](https://github.com/Exoridus/ExoJS/blob/main/src/resources/IndexedDbDatabase.ts#L21)
