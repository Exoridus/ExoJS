...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/webgpu/WebGpuBackend.ts#L80"
---
## Import
...
- `pushStencilClip(_shape: Geometry, _transform: Matrix): this`
...
[src/rendering/webgpu/WebGpuBackend.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/webgpu/WebGpuBackend.ts#L80)
