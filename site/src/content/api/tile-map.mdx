...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-tilemap/src/TileMap.ts#L49"
---
## Import
...
[packages/exojs-tilemap/src/TileMap.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-tilemap/src/TileMap.ts#L49)
