...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/math/Polygon.ts#L34"
---
## Import
...
[src/math/Polygon.ts](https://github.com/Exoridus/ExoJS/blob/main/src/math/Polygon.ts#L34)
