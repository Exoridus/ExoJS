...
sourcePath: "src/particles/modules/SpawnModule.ts"
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/SpawnModule.ts#L27"
---
# SpawnModule
`import { SpawnModule } from '@codexo/exojs'`
...
- `destroy(): void`
Source: [src/particles/modules/SpawnModule.ts](https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/SpawnModule.ts#L27)
