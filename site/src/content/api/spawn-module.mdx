...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/SpawnModule.ts#L27"
---
## Import
...
[packages/exojs-particles/src/modules/SpawnModule.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/SpawnModule.ts#L27)
