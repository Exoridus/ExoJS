...
sourcePath: "src/particles/modules/VelocityOverLifetime.ts"
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/VelocityOverLifetime.ts#L29"
---
# VelocityOverLifetime
`import { VelocityOverLifetime } from '@codexo/exojs'`
...
- `curve: Curve<>`
Source: [src/particles/modules/VelocityOverLifetime.ts](https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/VelocityOverLifetime.ts#L29)
