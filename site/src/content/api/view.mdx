...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/View.ts#L59"
---
## Import
...
[src/rendering/View.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/View.ts#L59)
