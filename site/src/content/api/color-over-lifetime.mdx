...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/ColorOverLifetime.ts#L21"
---
## Import
...
[packages/exojs-particles/src/modules/ColorOverLifetime.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/ColorOverLifetime.ts#L21)
