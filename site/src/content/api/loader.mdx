...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/resources/Loader.ts#L177"
---
## Import
...
- `load(type: T, path: string, options?: unknown): LoadingQueue<LoadReturn<T>>`
...
[src/resources/Loader.ts](https://github.com/Exoridus/ExoJS/blob/main/src/resources/Loader.ts#L177)
