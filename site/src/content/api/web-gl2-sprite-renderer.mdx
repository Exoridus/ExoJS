...
- `backendType: WebGl2`
Source: [src/rendering/webgl2/WebGl2SpriteRenderer.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/webgl2/WebGl2SpriteRenderer.ts#L52)
