...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/primitives/Graphics.ts#L47"
---
## Import
...
[src/rendering/primitives/Graphics.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/primitives/Graphics.ts#L47)
