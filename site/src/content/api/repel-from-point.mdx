...
sourcePath: "src/particles/modules/RepelFromPoint.ts"
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/RepelFromPoint.ts#L17"
---
# RepelFromPoint
`import { RepelFromPoint } from '@codexo/exojs'`
...
- `x: number`
- `y: number`
Source: [src/particles/modules/RepelFromPoint.ts](https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/RepelFromPoint.ts#L17)
