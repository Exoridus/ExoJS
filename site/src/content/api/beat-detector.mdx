...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-audio-fx/src/BeatDetector.ts#L126"
---
## Import
...
single BeatDetector.onBeat signal carries both via BeatInfo.status. Set
`emitProvisionalBeats: false` to receive only locked beats. Time-signature
...
[packages/exojs-audio-fx/src/BeatDetector.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-audio-fx/src/BeatDetector.ts#L126)
