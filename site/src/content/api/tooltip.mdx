...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/ui/Tooltip.ts#L48"
---
## Import
...
[src/ui/Tooltip.ts](https://github.com/Exoridus/ExoJS/blob/main/src/ui/Tooltip.ts#L48)
