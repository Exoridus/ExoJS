...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/RenderBatch.ts#L26"
---
## Import
...
[src/rendering/RenderBatch.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/RenderBatch.ts#L26)
