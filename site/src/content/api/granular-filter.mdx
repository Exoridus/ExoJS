...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/GranularFilter.ts#L35"
---
## Import
...
[src/audio/filters/GranularFilter.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/GranularFilter.ts#L35)
