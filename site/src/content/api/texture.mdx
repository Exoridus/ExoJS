...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/Texture.ts#L21"
---
# Texture
...
- `empty: Texture<>`
Source: [src/rendering/texture/Texture.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/Texture.ts#L21)
