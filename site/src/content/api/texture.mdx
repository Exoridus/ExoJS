...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/Texture.ts#L22"
---
## Import
...
[src/rendering/texture/Texture.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/Texture.ts#L22)
