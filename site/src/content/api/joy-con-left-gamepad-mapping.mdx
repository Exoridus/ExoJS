...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/input/JoyConLeftGamepadMapping.ts#L19"
---
# JoyConLeftGamepadMapping
...
- `family: JoyConLeft`
Source: [src/input/JoyConLeftGamepadMapping.ts](https://github.com/Exoridus/ExoJS/blob/main/src/input/JoyConLeftGamepadMapping.ts#L19)
