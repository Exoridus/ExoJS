...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/BiquadEffect.ts#L27"
---
## Import
...
[src/audio/BiquadEffect.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/BiquadEffect.ts#L27)
