...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/sprite/Sprite.ts#L44"
---
# Sprite
...
Source: [src/rendering/sprite/Sprite.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/sprite/Sprite.ts#L44)
