...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/VocoderFilter.ts#L34"
---
## Import
...
[src/audio/filters/VocoderFilter.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/VocoderFilter.ts#L34)
