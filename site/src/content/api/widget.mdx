...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/ui/Widget.ts#L36"
---
## Import
...
[src/ui/Widget.ts](https://github.com/Exoridus/ExoJS/blob/main/src/ui/Widget.ts#L36)
