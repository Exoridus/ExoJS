...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/ApplyForce.ts#L15"
---
## Import
...
[packages/exojs-particles/src/modules/ApplyForce.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/ApplyForce.ts#L15)
