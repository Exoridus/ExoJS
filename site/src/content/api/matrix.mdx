...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/math/Matrix.ts#L23"
---
# Matrix
...
- `z: number`
- `identity: Matrix<>`
Source: [src/math/Matrix.ts](https://github.com/Exoridus/ExoJS/blob/main/src/math/Matrix.ts#L23)
