...
sourcePath: "src/particles/modules/Turbulence.ts"
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/Turbulence.ts#L23"
---
# Turbulence
`import { Turbulence } from '@codexo/exojs'`
...
- `strength: number`
- `timeScale: number`
Source: [src/particles/modules/Turbulence.ts](https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/Turbulence.ts#L23)
