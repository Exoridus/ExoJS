...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/WorkletFilter.ts#L20"
---
## Import
...
[src/audio/filters/WorkletFilter.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/WorkletFilter.ts#L20)
