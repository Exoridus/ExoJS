...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/ColorOverSpeed.ts#L25"
---
## Import
...
[packages/exojs-particles/src/modules/ColorOverSpeed.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/ColorOverSpeed.ts#L25)
