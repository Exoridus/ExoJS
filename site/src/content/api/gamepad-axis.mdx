...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/input/GamepadAxis.ts#L101"
---
## Import
...
[src/input/GamepadAxis.ts](https://github.com/Exoridus/ExoJS/blob/main/src/input/GamepadAxis.ts#L101)
