...
- `family: JoyConRight`
Source: [src/input/JoyConRightGamepadMapping.ts](https://github.com/Exoridus/ExoJS/blob/main/src/input/JoyConRightGamepadMapping.ts#L19)
