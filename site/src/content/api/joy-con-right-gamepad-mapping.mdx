...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/input/JoyConRightGamepadMapping.ts"
---
## Import
...
- `family: JoyConRight` - Identifies the device family this mapping targets.

## Source

[src/input/JoyConRightGamepadMapping.ts](https://github.com/Exoridus/ExoJS/blob/main/src/input/JoyConRightGamepadMapping.ts)
