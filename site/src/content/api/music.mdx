...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/Music.ts#L27"
---
## Import
...
[src/audio/Music.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/Music.ts#L27)
