...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/RenderTarget.ts#L17"
---
# RenderTarget
...
- `_view: View<>`
- `_viewport: Rectangle<>`
Source: [src/rendering/RenderTarget.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/RenderTarget.ts#L17)
