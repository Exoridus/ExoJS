...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/resources/CacheFirstStrategy.ts"
---
## Import
...
- `resolve(request: CacheRequest, stores: readonly CacheStore[]): Promise<unknown>` - Resolves a single asset according to the strategy's caching policy and returns the fully constructed resource.

## Source

[src/resources/CacheFirstStrategy.ts](https://github.com/Exoridus/ExoJS/blob/main/src/resources/CacheFirstStrategy.ts)
