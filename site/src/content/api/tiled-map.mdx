...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-tiled/src/TiledMap.ts#L30"
---
## Import
...
[packages/exojs-tiled/src/TiledMap.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-tiled/src/TiledMap.ts#L30)
