...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/math/Circle.ts#L37"
---
## Import
...
[src/math/Circle.ts](https://github.com/Exoridus/ExoJS/blob/main/src/math/Circle.ts#L37)
