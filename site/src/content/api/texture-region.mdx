...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/TextureRegion.ts#L162"
---
## Import
...
[src/rendering/texture/TextureRegion.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/TextureRegion.ts#L162)
