...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/input/GamepadButton.ts#L84"
---
## Import
...
[src/input/GamepadButton.ts](https://github.com/Exoridus/ExoJS/blob/main/src/input/GamepadButton.ts#L84)
