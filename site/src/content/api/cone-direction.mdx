...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/distributions/ConeDirection.ts"
---
## Import
...
- `omni(minSpeed: number, maxSpeed: number): ConeDirection` - Convenience: omnidirectional emission (full circle, 0..2π).
...
[packages/exojs-particles/src/distributions/ConeDirection.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/distributions/ConeDirection.ts)
