...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/DataTexture.ts#L110"
---
## Import
...
[src/rendering/texture/DataTexture.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/DataTexture.ts#L110)
