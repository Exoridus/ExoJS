...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/filters/BlurFilter.ts#L24"
---
# BlurFilter
...
- `destroy(): void`
Source: [src/rendering/filters/BlurFilter.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/filters/BlurFilter.ts#L24)
