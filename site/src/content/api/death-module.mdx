...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/DeathModule.ts#L21"
---
## Import
...
[packages/exojs-particles/src/modules/DeathModule.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/DeathModule.ts#L21)
