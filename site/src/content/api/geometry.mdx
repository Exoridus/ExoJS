...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/geometry/Geometry.ts#L101"
---
## Import
...
[src/rendering/geometry/Geometry.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/geometry/Geometry.ts#L101)
