...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/text/BitmapText.ts#L152"
---
## Import
...
[src/rendering/text/BitmapText.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/text/BitmapText.ts#L152)
