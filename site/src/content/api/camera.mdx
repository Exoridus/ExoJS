...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/Camera.ts#L28"
---
## Import
...
[src/rendering/Camera.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/Camera.ts#L28)
