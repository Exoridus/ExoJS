...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/AudioAnalyser.ts#L49"
---
## Import
...
[src/audio/AudioAnalyser.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/AudioAnalyser.ts#L49)
