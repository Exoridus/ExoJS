...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/math/Line.ts#L33"
---
# Line
...
Source: [src/math/Line.ts](https://github.com/Exoridus/ExoJS/blob/main/src/math/Line.ts#L33)
