...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/CallbackRenderPass.ts#L40"
---
## Import
...
[src/rendering/CallbackRenderPass.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/CallbackRenderPass.ts#L40)
