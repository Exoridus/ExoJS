...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/CallbackRenderPass.ts#L38"
---
## Import
...
[src/rendering/CallbackRenderPass.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/CallbackRenderPass.ts#L38)
