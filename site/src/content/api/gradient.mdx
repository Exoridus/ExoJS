...
sourcePath: "src/particles/distributions/ColorGradient.ts"
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/particles/distributions/ColorGradient.ts#L33"
---
## Import

`import { ColorGradient } from '@codexo/exojs'`
...
[src/particles/distributions/ColorGradient.ts](https://github.com/Exoridus/ExoJS/blob/main/src/particles/distributions/ColorGradient.ts#L33)
