...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/animation/Easing.ts"
---
## Import
...
[src/animation/Easing.ts](https://github.com/Exoridus/ExoJS/blob/main/src/animation/Easing.ts)
