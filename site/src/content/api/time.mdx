...
- `fromHours(value: number): Time`
- `fromMilliseconds(value: number): Time`
- `fromMinutes(value: number): Time`
- `fromSeconds(value: number): Time`
- `now(): Time`
...
[src/core/Time.ts](https://github.com/Exoridus/ExoJS/blob/main/src/core/Time.ts#L17)
