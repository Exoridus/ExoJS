...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/animation/Tween.ts#L34"
---
# Tween
...
Source: [src/animation/Tween.ts](https://github.com/Exoridus/ExoJS/blob/main/src/animation/Tween.ts#L34)
