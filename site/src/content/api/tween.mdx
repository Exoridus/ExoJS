...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/animation/Tween.ts#L38"
---
## Import
...
[src/animation/Tween.ts](https://github.com/Exoridus/ExoJS/blob/main/src/animation/Tween.ts#L38)
