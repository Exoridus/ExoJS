...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/PitchShiftFilter.ts#L33"
---
## Import
...
[src/audio/filters/PitchShiftFilter.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/filters/PitchShiftFilter.ts#L33)
