...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/RenderNode.ts#L81"
---
## Import
...
[src/rendering/RenderNode.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/RenderNode.ts#L81)
