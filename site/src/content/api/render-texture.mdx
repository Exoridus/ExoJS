...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/RenderTexture.ts#L19"
---
## Import
...
[src/rendering/texture/RenderTexture.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/texture/RenderTexture.ts#L19)
