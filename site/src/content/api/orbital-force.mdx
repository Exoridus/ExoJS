...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/OrbitalForce.ts#L22"
---
## Import
...
[packages/exojs-particles/src/modules/OrbitalForce.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-particles/src/modules/OrbitalForce.ts#L22)
