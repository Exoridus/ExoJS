...
sourcePath: "src/particles/modules/AlphaFadeOverLifetime.ts"
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/AlphaFadeOverLifetime.ts#L24"
---
# AlphaFadeOverLifetime
`import { AlphaFadeOverLifetime } from '@codexo/exojs'`
...
- `curve: Curve<>`
Source: [src/particles/modules/AlphaFadeOverLifetime.ts](https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/AlphaFadeOverLifetime.ts#L24)
