...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/core/SceneNode.ts#L70"
---
## Import
...
[src/core/SceneNode.ts](https://github.com/Exoridus/ExoJS/blob/main/src/core/SceneNode.ts#L70)
