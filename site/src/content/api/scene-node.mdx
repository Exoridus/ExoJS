...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/core/SceneNode.ts#L69"
---
## Import
...
rotation, scale, **skew**, origin, and a 2-component Vector `anchor` used to
...
- `skewX: number` — horizontal skew angle in degrees; shears the node along the X axis
- `skewY: number` — vertical skew angle in degrees; shears the node along the Y axis

## Source

[src/core/SceneNode.ts](https://github.com/Exoridus/ExoJS/blob/main/src/core/SceneNode.ts#L69)
