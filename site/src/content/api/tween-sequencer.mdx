...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/animation/TweenSequencer.ts#L58"
---
## Import
...
[src/animation/TweenSequencer.ts](https://github.com/Exoridus/ExoJS/blob/main/src/animation/TweenSequencer.ts#L58)
