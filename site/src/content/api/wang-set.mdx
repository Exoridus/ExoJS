...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-tilemap/src/WangSet.ts#L56"
---
## Import
...
[packages/exojs-tilemap/src/WangSet.ts](https://github.com/Exoridus/ExoJS/blob/main/packages/exojs-tilemap/src/WangSet.ts#L56)
