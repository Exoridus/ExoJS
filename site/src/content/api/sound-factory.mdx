...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/resources/factories/SoundFactory.ts#L33"
---
# SoundFactory
...
- `_objectUrls: string[]`
- `storageName: "sound"`
Source: [src/resources/factories/SoundFactory.ts](https://github.com/Exoridus/ExoJS/blob/main/src/resources/factories/SoundFactory.ts#L33)
