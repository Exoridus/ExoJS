...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/resources/LoadingQueue.ts#L27"
---
## Import
...
- `new(promise: Promise<T>, count: number): LoadingQueue<T>`

## Methods

- `_notifyItem(success: boolean): void`
...
[src/resources/LoadingQueue.ts](https://github.com/Exoridus/ExoJS/blob/main/src/resources/LoadingQueue.ts#L27)
