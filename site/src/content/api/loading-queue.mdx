...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/resources/LoadingQueue.ts#L26"
---
## Import
...
[src/resources/LoadingQueue.ts](https://github.com/Exoridus/ExoJS/blob/main/src/resources/LoadingQueue.ts#L26)
