...
sourcePath: "src/particles/modules/AttractToPoint.ts"
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/AttractToPoint.ts#L20"
---
# AttractToPoint
`import { AttractToPoint } from '@codexo/exojs'`
...
- `x: number`
- `y: number`
Source: [src/particles/modules/AttractToPoint.ts](https://github.com/Exoridus/ExoJS/blob/main/src/particles/modules/AttractToPoint.ts#L20)
