...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/sprite/RepeatingSprite.ts#L38"
---
## Import
...
[src/rendering/sprite/RepeatingSprite.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/sprite/RepeatingSprite.ts#L38)
