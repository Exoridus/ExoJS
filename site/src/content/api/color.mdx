...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/core/Color.ts#L23"
---
## Import
...
[src/core/Color.ts](https://github.com/Exoridus/ExoJS/blob/main/src/core/Color.ts#L23)
