...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/debug/RenderPassInspectorLayer.ts#L79"
---
## Import
...
[src/debug/RenderPassInspectorLayer.ts](https://github.com/Exoridus/ExoJS/blob/main/src/debug/RenderPassInspectorLayer.ts#L79)
