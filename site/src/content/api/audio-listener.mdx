...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/audio/AudioListener.ts"
---
## Import
...
- `_tick(): void` - Internal: called by AudioManager.update() once per frame.
- `destroy(): void`
...
[src/audio/AudioListener.ts](https://github.com/Exoridus/ExoJS/blob/main/src/audio/AudioListener.ts)
