...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/core/Scene.ts#L119"
---
## Import
...
[src/core/Scene.ts](https://github.com/Exoridus/ExoJS/blob/main/src/core/Scene.ts#L119)
