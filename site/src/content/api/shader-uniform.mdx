...
sourceUrl: "https://github.com/Exoridus/ExoJS/blob/main/src/rendering/shader/ShaderUniform.ts#L13"
---
## Import
...
[src/rendering/shader/ShaderUniform.ts](https://github.com/Exoridus/ExoJS/blob/main/src/rendering/shader/ShaderUniform.ts#L13)
