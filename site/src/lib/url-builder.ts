...
export const resolveSiteBaseUrl = (fallbackBase = '/'): string => {
...
export const configureUrlsFromLocation = (fallbackBase = '/'): void => {
  configureUrls({
...
export const buildGithubRawExampleUrl = (versionId: string, filePath: string, params?: UrlParams): string => {
