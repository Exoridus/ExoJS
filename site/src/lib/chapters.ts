...
export const CHAPTERS: ReadonlyArray<ChapterMeta> = [
    ...
    { order: 5, slug: 'input', title: 'Input (Keyboard, Mouse, Pointer, Gamepad)', complexity: 'Low' },
    { order: 6, slug: 'scene-graph', title: 'Container & Scene Graph', complexity: 'Medium' },
    { order: 7, slug: 'audio-basics', title: 'Audio Basics', complexity: 'Low' },
    { order: 8, slug: 'spatial-audio', title: 'Spatial Audio & Listener', complexity: 'Medium' },
    ...
    { order: 13, slug: 'render-targets', title: 'Render Targets & Post-Processing', complexity: 'High' },
    { order: 14, slug: 'performance', title: 'Performance & Profiling', complexity: 'Medium' },
    { order: 15, slug: 'audio-fx', title: 'Audio FX', complexity: 'Medium' },
    { order: 16, slug: 'beat-detection', title: 'Beat Detection & Music Sync', complexity: 'High' },
    { order: 17, slug: 'debug-layer', title: 'Debug Layer', complexity: 'Low' },
    { order: 18, slug: 'custom-renderers', title: 'Advanced: Custom Renderers', complexity: 'Very high' },
    { order: 19, slug: 'showcase', title: 'Showcase (combined recipes)', complexity: 'Mixed' },
];
