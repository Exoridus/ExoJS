...
const ARCHETYPE_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  'lights-unshadowed': 'A fixed sprite field under a growing number of lights, accumulated into a light target. No shadows.',
  'lights-shadowed': 'The same field and lights, with a fixed set of occluding boxes, so every light also resolves a shadow term.',
...
const ARCHETYPE_TITLES: Readonly<Record<string, string>> = {
  ...
  'lights-unshadowed': 'Lighting a scene',
  'lights-shadowed': 'Lighting a scene with shadows',
