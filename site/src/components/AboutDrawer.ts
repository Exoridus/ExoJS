...
export class AboutDrawer extends LitElement {
    ...
    public render(): ReturnType<LitElement['render']> {
        ...
        return html`
            <div class="scrim" ?data-open=${this.open} @click=${this._emitClose} aria-hidden="true"></div>
            <aside
                class="drawer"
                ?data-open=${this.open}
                role="dialog"
                ...
                <header class="drawer-header">
                    <div class="hero">
                        ...
                        <p class="hero-subtitle">
                            Interactive playground for the ExoJS multimedia framework. Select an example on the left, edit the source, and see the preview
                            update live.
                        </p>
                    </div>
                    <button class="close" data-role="close" aria-label="Close" @click=${this._emitClose}>
                            ...
                            ? html`
                                  <div class="row">
                                      ...
                                      <dd class="row-value">
                                          ...
                                          >
                                              ${this._copiedField === 'version' ? 'Copied' : 'Copy'}
                                          </button>
                                      </dd>
                                  </div>
                              `
                            ...
                            ? html`
                                  <div class="row">
                                      ...
                                      <dd class="row-value">
                                          ...
                                          >
                                              ${this._copiedField === 'install' ? 'Copied' : 'Copy'}
                                          </button>
                                      </dd>
                                  </div>
                              `
                        ...
                        ${this.repositoryUrl
                            ? html`
                                  <div class="row">
                                      ...
                                      <dd class="row-value">
                                          <a class="row-link" href=${this.repositoryUrl} target="_blank" rel="noopener noreferrer"> ${repoDisplay} </a>
                                      </dd>
                                  </div>
                              `
                            : nothing}
    ...
    private _buildInstallCommand(activeVersion: string): string {
        ...
        return activeVersion ? `npm i ${this.packageName}@${activeVersion}` : `npm i ${this.packageName}`;
    }
