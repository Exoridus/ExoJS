...
export class NavigationLink extends LitElement {
    ...
    public render(): ReturnType<LitElement['render']> {
        const tooltip = this.unavailable ? `${this.title}\n${this.unavailableReason || 'Unavailable in this browser.'}` : this.description || this.title;
    ...
    private _onClick(event: MouseEvent): void {
        ...
        this.dispatchEvent(
            new CustomEvent<SelectExampleEvent>('select-example', {
