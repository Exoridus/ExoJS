 ...
 */
export const makeTiledContext = (fixtures: Record<string, unknown>, textureSizes: Record<string, { w: number; h: number }> = {}) => {
  ...
  const loadSource = async (source: string, options?: unknown): Promise<TiledMap> => {
