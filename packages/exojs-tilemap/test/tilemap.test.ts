...
describe('TileLayer', () => {
    ...
    expect(
      () =>
        new TileLayer({
          ...
          tileWidth: 16,
          tileHeight: 16,
          tilesets: null as unknown as TileSet[],
        }),
  ...
  it('_adoptChunk installs a chunk-provider payload directly', () => {
    ...
    const tiles = new Uint32Array([packTile(0, 1, TILE_TRANSFORM_IDENTITY), 0, 0, packTile(0, 2, TILE_TRANSFORM_IDENTITY)]);
  ...
  it('rejects mixed width/height (one provided, one omitted)', () => {
    ...
    ).toThrow(/width and height must both be provided/);
    expect(
      () =>
        new TileLayer({
          id: 0,
...
describe('TileMap', () => {
  ...
  it('getObjectLayerById finds an object layer by ID', () => {
    const map = new TileMap({
      ...
      tileWidth: 32,
      tileHeight: 32,
      objectLayers: [new ObjectLayer({ id: 1, name: 'spawns' }), new ObjectLayer({ id: 2, name: 'triggers' })],
    });
  ...
  it('getImageLayerById finds an image layer by ID', () => {
    const map = new TileMap({
      ...
      tileWidth: 32,
      tileHeight: 32,
      imageLayers: [new ImageLayer({ id: 1, name: 'bg', image: 'bg.png' }), new ImageLayer({ id: 2, name: 'fg', image: 'fg.png' })],
    });
  ...
  it('getTileAt convenience', () => {
    const map = new TileMap({
      ...
      tileHeight: 32,
      tilesets: [ts],
      layers: [new TileLayer({ id: 1, name: 'l', width: 64, height: 64, tileWidth: 32, tileHeight: 32, tilesets: [ts] })],
    });
    const ref = { tileset: ts, localTileId: 3, transform: TILE_TRANSFORM_IDENTITY };
  ...
  it('multiple tilesets', () => {
    ...
    const map = new TileMap({
      ...
      tileHeight: 32,
      tilesets: [ts1, ts2],
      layers: [new TileLayer({ id: 0, name: 'l', width: 64, height: 64, tileWidth: 32, tileHeight: 32, tilesets: [ts1, ts2] })],
    });
  ...
  it('destroy is idempotent', () => {
    const map = new TileMap({
      ...
      tileHeight: 32,
      tilesets: [ts],
      layers: [new TileLayer({ id: 0, name: 'l', width: 64, height: 64, tileWidth: 32, tileHeight: 32, tilesets: [ts] })],
    });
    map.destroy();
    map.destroy();
  ...
  it('addImageLayer throws when an image layer with the same ID already exists', () => {
    ...
    expect(() => map.addImageLayer(new ImageLayer({ id: 7, name: 'bg2', image: 'bg2.png' }))).toThrow(/Image layer ID 7 already exists/);
