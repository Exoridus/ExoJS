...
/**
 * Standard Robert Penner easing functions.
...
export const Ease = {
  ...
  quintInOut: (t: number): number => (t < 0.5 ? 16 * t * t * t * t * t : 1 - Math.pow(-2 * t + 2, 5) / 2),
  ...
  bounceOut: bounceOutFn,
  bounceIn: (t: number): number => 1 - bounceOutFn(1 - t),
