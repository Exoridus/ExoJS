...
/** Subtitle text together with the format its locator identified it as. */
export interface SubtitleSource {
  readonly fmt: SubtitleFormat;
...
/**
 * The subtitle format a locator names, by file suffix. Anything but `.srt`
 ...
 *
 * VTT cue settings (`align`, `line`, `position`, `size`, `vertical`) are
 * applied; SRT cues keep their default positional properties, which the format
