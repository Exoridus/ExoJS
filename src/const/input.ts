...
export type InputChannel = Gamepad | Keyboard;

export const defaultGamepadButtons = [
...
export const defaultGamepadAxes = [
...
export const defaultGamepadMapping = new GamepadMapping(defaultGamepadButtons, defaultGamepadAxes);
