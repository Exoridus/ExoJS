...
type SignalHandler =  (...params: Array<any>) => void | boolean;
...
export default class Signal {
    ...
    public readonly bindings = new Array<SignalBinding>();

    has(handler: SignalHandler, context?: object): boolean {
        return this.bindings.some((binding) => (binding.handler === handler && binding.context === context));
    }

    add(handler: SignalHandler, context?: object): this {
    ...
    once(handler: SignalHandler, context?: object): this {
    ...
    remove(handler: SignalHandler, context?: object): this {
    ...
    dispatch(...params: Array<any>): this {
