...
const channelsByToken = new Map<InputToken, InputChannel>([
  ...
  ['keyboard.backquote', Keyboard.Backquote],
  ['keyboard.minus', Keyboard.Minus],
  ['keyboard.equal', Keyboard.Equal],
  ['keyboard.bracket-left', Keyboard.BracketLeft],
  ['keyboard.bracket-right', Keyboard.BracketRight],
  ['keyboard.backslash', Keyboard.Backslash],
  ['keyboard.semicolon', Keyboard.Semicolon],
  ['keyboard.quote', Keyboard.Quote],
  ['keyboard.comma', Keyboard.Comma],
  ['keyboard.period', Keyboard.Period],
  ['keyboard.slash', Keyboard.Slash],
