...
import { getCollisionCircleRectangle, getCollisionEllipseRectangle, getCollisionRectangleRectangle, getCollisionSat } from '@/math/collision-detection';
import {
...
export class Rectangle implements ShapeLike {
  ...
  public containsRect(rect: Rectangle): boolean {
    return (
      inRange(rect.left, this.left, this.right) &&
  ...
  public intersectsWith(target: Collidable): boolean {
    switch (target.collisionType) {
      ...
      case CollisionType.Polygon:
        return intersectionRectPoly(this, target as Polygon);
      case CollisionType.Circle:
        return intersectionRectCircle(this, target as Circle);
      case CollisionType.Ellipse:
        return intersectionRectEllipse(this, target as Ellipse);
      case CollisionType.Line:
        return intersectionLineRect(target as Line, this);
      case CollisionType.Point:
        return intersectionPointRect(target as Vector, this);
      default:
        return false;
    }
  }
