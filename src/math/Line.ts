...
export class Line implements ShapeLike {
  ...
  public intersectsWith(target: Collidable): boolean {
    switch (target.collisionType) {
      case CollisionType.SceneNode:
        return intersectionLineRect(this, (target as SceneNode).getBounds());
      case CollisionType.Rectangle:
        return intersectionLineRect(this, target as Rectangle);
      case CollisionType.Polygon:
        return intersectionLinePoly(this, target as Polygon);
      case CollisionType.Circle:
        return intersectionLineCircle(this, target as Circle);
      case CollisionType.Ellipse:
        return intersectionLineEllipse(this, target as Ellipse);
      case CollisionType.Line:
        return intersectionLineLine(this, target as Line);
      case CollisionType.Point:
        return intersectionPointLine(target as Vector, this);
      default:
        return false;
    }
  }
  ...
  public equals({ fromX, fromY, toX, toY }: Partial<Line> = {}): boolean {
    return (
      (fromX === undefined || this.fromX === fromX) &&
