...
export class Matrix implements Cloneable {
  ...
  public constructor(a = 1, b = 0, x = 0, c = 0, d = 1, y = 0, e = 0, f = 0, z = 1) {
    this.a = a;
    this.b = b;
    this.x = x;
  ...
  public set(a = this.a, b = this.b, x = this.x, c = this.c, d = this.d, y = this.y, e = this.e, f = this.f, z = this.z): this {
    this.a = a;
    this.b = b;
    this.x = x;
    this.c = c;
  ...
  public clone(): this {
    return new Matrix(this.a, this.b, this.x, this.c, this.d, this.y, this.e, this.f, this.z) as this;
  }

  public equals({ a, b, x, c, d, y, e, f, z }: Partial<Matrix> = {}): boolean {
    return (
