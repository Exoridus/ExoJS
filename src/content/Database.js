import { indexedDBSupported } from '../core/Utils';
...
export default class Database {
    ...
    clear(type = null) {
        ...
        return this.getObjectStore(type, 'readwrite').then((store) => new Promise((resolve, reject) => {
     ...
     */
    delete() {
        return this.close().then(() => new Promise((resolve, reject) => {
     ...
     */
    loadData(type, key) {
        return this.getObjectStore(type).then((store) => new Promise((resolve, reject) => {
    ...
    getObjectStore(type, transactionMode = 'readonly') {
        ...
        return this.open().then(() => this._database.transaction([type], transactionMode).objectStore(type));
    }
}
