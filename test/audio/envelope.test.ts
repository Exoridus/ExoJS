...
describe('Envelope', () => {
    ...
    test('trigger() schedules in the correct order', () => {
        ...
        param.cancelScheduledValues.mockImplementation(() => { callOrder.push('cancel'); return param; });
        param.setValueAtTime.mockImplementation(() => { callOrder.push('setValue'); return param; });
        param.linearRampToValueAtTime.mockImplementation(() => { callOrder.push('ramp'); return param; });
