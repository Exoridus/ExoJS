import '#assets/coreAssetBindings'; // side-effect: registers core kinds

import { describe, expect, it } from 'vitest';

import { createLeaf, getAssetKind, registerAssetKind } from '#assets/assetKindRegistry';
...
describe('assetKindRegistry', () => {
  ...
  it('registerAssetKind throws when re-registering a kind with a different adapter', () => {
    // texture is already registered by the '#assets/coreAssetBindings' side-effect import above.
