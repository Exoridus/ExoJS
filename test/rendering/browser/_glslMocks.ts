...
vi.mock('#rendering/webgl2/glsl/backdrop-blend.frag', async () => ({ default: (await import('../../../src/rendering/webgl2/glsl/backdrop-blend.frag?raw')).default }));
vi.mock('#rendering/webgl2/glsl/backdrop-blend.vert', async () => ({ default: (await import('../../../src/rendering/webgl2/glsl/backdrop-blend.vert?raw')).default }));
...
vi.mock('#rendering/webgl2/glsl/particle.frag', async () => ({ default: (await import('../../../src/rendering/webgl2/glsl/particle.frag?raw')).default }));
vi.mock('#rendering/webgl2/glsl/particle.vert', async () => ({ default: (await import('../../../src/rendering/webgl2/glsl/particle.vert?raw')).default }));
...
vi.mock('#rendering/webgl2/glsl/stencil-clip.frag', async () => ({ default: (await import('../../../src/rendering/webgl2/glsl/stencil-clip.frag?raw')).default }));
vi.mock('#rendering/webgl2/glsl/stencil-clip.vert', async () => ({ default: (await import('../../../src/rendering/webgl2/glsl/stencil-clip.vert?raw')).default }));
