...
This site is deployed by the `.github/workflows/pages.yml` workflow in the repo root. The build runs on `master` and is decoupled from library CI.
...
- `scripts/` — vendor-sync helpers (exojs, Monaco, stats.js, Kenney input prompts)
